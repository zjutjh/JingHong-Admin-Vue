    ...
    <n-space style="width: 100%">
      <n-form style="max-width: 400px">
        <n-form-item label="标题">
          <n-input v-model:value="formData.title" style="width: 400px" maxlength="9999"/>
        </n-form-item>
        <n-form-item label="内容">
          <n-input type="textarea" maxlength="99999" v-model:value="formData.content" :autosize="{ minRows: 5 }"
            style="width: 400px" />
        </n-form-item>
